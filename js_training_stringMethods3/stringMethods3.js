...
function getSandwich(str) {
    let breadIndex = str.indexOf("bread");
    let breadLastIndex = str.lastIndexOf("bread");
    if (breadIndex != breadLastIndex) {
        console.log(str.substring(breadIndex + 5, breadLastIndex));
    }
}

getSandwich("breadjambread") // "jam"
getSandwich("xxbreadcheesebreadyy") // "cheese"
getSandwich("xxbreadyy") // ""
...
function seeColor(str) {
    let strFirst4Chars = str.substr(0, 4);

    if (strFirst4Chars.includes("red")) {
        console.log("red");
    } else if (strFirst4Chars.includes("blue")) {
        console.log("blue");
    } else {
        console.log("");
    }
